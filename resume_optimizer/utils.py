...
def read_file(file_path):
    with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
        content = file.read()  # No need to decode further
    return content
...
def get_all_skills():
    skills = []
    with open('resume_optimizer/data/all_linkedin_skills.txt', 'r', encoding='utf-8', errors='ignore') as input_file:
...
def extract_skills(text_string):
    ...
    extractor = keyword_extract.KeywordExtractor()
